...
fn main() {
    ...
    //let r1: Rule = serde_json::from_str(&r#"{"id":"010000092","keyword":[{"id":4000,"content":"=","check_after":"none","target":["req.filename","req.args"]},{"id":4003,"content":"ref","check_after":"both","target":["req.filename","req.args"]}],"content":"keyword contains \"|4003:req.filename|\""}"#.to_string()).unwrap();
    //let r1: Rule = serde_json::from_str(&r#"{"id":"010000092","keyword":[{"id":4000,"content":"=","check_after":"none","target":["req.filename","req.args"]},{"id":4003,"content":"ref","check_after":"both","target":["req.filename","req.args"]}],"content":"keyword contains \"4000:req.filename|\""}"#.to_string()).unwrap();
